...
|:---|:---|:---|
| **Isaac Gym** | Middleware between physics engine and simulation setup. Simplifies simulation setup. | 1. Download the Isaac Gym repository from the [website](https://developer.nvidia.com/isaac-gym/download). Although the docs mention Ubuntu 18/20, Ubuntu 22 works fine.<br>2. Unzip the repo in your workspace.|
| **rsl_rl** | A fast and simple implementation of learning algorithms for robotics. | 1. Clone [rsl_rl](https://github.com/leggedrobotics/rsl_rl)<br>2. Run:<br>`cd rsl_rl && git checkout v1.0.2 && pip install -e .` |
| **unitree_rl_gym** | rsl_rl implementation for Unitree robots. | 1. Clone [unitree_rl_gym](https://github.com/unitreerobotics/unitree_rl_gym) |
| **unitree_g1_doors** | My implementation of door environment for Unitree G1. | 1. Clone [g1_doors](https://github.com/kushal-a/g1_doors) |
